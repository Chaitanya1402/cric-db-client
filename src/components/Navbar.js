  ...
  return (
    <div className='bg-purple-300 text-black'>
      <div className='w-[85%] h-16 flex m-auto justify-between items-center relative'>
        ...
        <div className='block md:hidden absolute right-0 text-2xl' onClick={handleNavbarToggle}>{isExpanded === false ? <i class="fa-solid fa-bars"></i> : <i class="fa-solid fa-xmark"></i>}</div>
